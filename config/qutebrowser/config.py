...
config.set('content.headers.user_agent', 'Mozilla/5.0 ({os_info}) AppleWebKit/{webkit_version} (KHTML, like Gecko) {'
                                         'upstream_browser_key}/{upstream_browser_version} Safari/{webkit_version}',
           'https://web.whatsapp.com/')
config.set('content.headers.user_agent', 'Mozilla/5.0 ({os_info}; rv:90.0) Gecko/20100101 Firefox/90.0',
           'https://accounts.google.com/*')
config.set('content.headers.user_agent', 'Mozilla/5.0 ({os_info}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99 '
                                         'Safari/537.36', 'https://*.slack.com/*')
...
config.set('url.start_pages', [f'{XDG_TEMPLATES_DIR}/wal-startpage/index.html'])
...
c.colors.keyhint.fg = color['color5']
c.colors.keyhint.suffix.fg = color['color13']
c.colors.messages.error.bg = color['color11']
c.colors.messages.error.border = color['color11']
c.colors.messages.error.fg = color['color5']
c.colors.messages.info.bg = color['color8']
c.colors.messages.info.border = color['color8']
c.colors.messages.info.fg = color['color5']
c.colors.messages.warning.bg = color['color12']
c.colors.messages.warning.border = color['color12']
c.colors.messages.warning.fg = color['color5']
c.colors.prompts.bg = color['color2']
