# Generated by Powerlevel10k configuration wizard on 2021-11-23 at 14:21 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 19497.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
#"" round separators, round heads, slanted tails, 2 lines, solid, full fr""ame,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL="%12F"
  ...
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=12
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROXY_BACKGROUND=8
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=12
  ...
  typeset -g POWERLEVEL9K_EXAMPLE_FOREGROUND=12
