...
components.active[1][2] = {
    ...
    enabled = shortline or
        function(winid) return vim.api.nvim_win_get_width(winid) > 70 end,
...
components.active[1][3] = {
    ...
    enabled = shortline or
        function(winid) return vim.api.nvim_win_get_width(winid) > 80 end,
...
components.active[3][7] = {
    provider = statusline_style.left,
    enabled = shortline or
        function(winid) return vim.api.nvim_win_get_width(winid) > 90 end,
