...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ modkey, "Control" }, "Return", function() awful.spawn(terminal .. " -e tmux new-session -A -s playground") end, { description = "open a playground tmux session", group = "launcher" }),
